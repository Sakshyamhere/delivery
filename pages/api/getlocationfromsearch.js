...
const handler = async (req, res) => {
    ...
    try {
        const response = await axios.get(`https://maps.googleapis.com/maps/api/place/autocomplete/json?input=${query}&sensor=false&components=country:np&key=${process.env.API_KEY}`);
